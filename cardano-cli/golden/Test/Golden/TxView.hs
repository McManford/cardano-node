...
golden_view_byron =
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    diffVsGoldenFile result "golden/files/golden/byron/transaction-view.out"
...
golden_view_shelley = let
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    result <-
      execCardanoCLI
        ["transaction", "view", "--tx-body-file", transactionBodyFile]
    diffVsGoldenFile result "golden/files/golden/shelley/transaction-view.out"
...
golden_view_allegra =
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    result <-
      execCardanoCLI
        ["transaction", "view", "--tx-body-file", transactionBodyFile]
    diffVsGoldenFile result "golden/files/golden/allegra/transaction-view.out"
...
golden_view_mary =
  ...
  moduleWorkspace "tmp" $ \tempDir -> do
    ...
    result <-
      execCardanoCLI
        ["transaction", "view", "--tx-body-file", transactionBodyFile]
    diffVsGoldenFile result "golden/files/golden/mary/transaction-view.out"
  ...
  propertyOnce $
    moduleWorkspace "tmp" $ \tempDir -> do
      ...
      result <-
        execCardanoCLI
          ["transaction", "view", "--tx-body-file", transactionBodyFile]
      diffVsGoldenFile result "golden/files/golden/alonzo/transaction-view.out"
